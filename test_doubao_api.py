...
def test_doubao_connection():
    ...
    if not api_key:
        print("❌ 错误: 未找到DOUBAO_API_KEY环境变量")
        print("\n请确保:")
        print("1. .env 文件存在")
        print("2. .env 文件中包含: DOUBAO_API_KEY=your-api-key")
        return False
    ...
    try:
        ...
        print("- API密钥是否正确")
        print("- 是否有网络连接")
        print("- 访问 https://console.volcengine.com/ark 查看账户状态")
        return False
...
def main():
    ...
    # 测试1: API连接
    connection_ok = test_doubao_connection()
    ...
    if not connection_ok:
        ...
        print("="*60)
        print("\n请按照以下步骤排查问题:")
        print("1. 确认.env文件中的DOUBAO_API_KEY是否正确")
        print("2. 检查网络连接是否正常")
        print("3. 访问 https://console.volcengine.com/ark 确认账户状态")
        print("4. 确认模型名称是否正确: doubao-seed-1-6-251015")
        return
